...
because what fields referenced by that code unfold to is polymorphic to
...
%
The problem is compounded by the occasional need to override fields in derived families,
which also precludes the unfolding of definitions.
...
the idiomatic programming experience in a proof assistant.
