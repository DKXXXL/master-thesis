...
}\YZreply{The sentence feels confusing because "these fields" are not sealed; rather, as you explain below, there's no need to seal anything when, say, doing exhaustiveness checking using Wrec.}
After compilation
