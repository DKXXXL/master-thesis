...
After these,
we will have four new kinds of judgements to model our linkages.
...
the rule "Type Universe" requires a well-typed context, even though it
does implicitly, because it is not possible to have ill-formed
contexts in our intrinsic setting.

Among them, sealing judgement $\goodSeal{\Gamma}{\_}{\sigma}{A}$ is the
