...
Because we consider each judgement as a (dependent) QIIT type, each judgement has a \textit{type} and each sequent is well-typed as well (otherwise how can they be encoded in Agda?)\YZ{What's the distinction of judgments vs. sequents?}.
...
presumptions about what is going on here.}
Thus the sealing judgement will be helpful to shift the context from $.. (T : \bW(\sigma)) .. $ to $.. (T : \cU) ..$
\YZ{Can we have a more concrete example of how the judgment is useful?}
