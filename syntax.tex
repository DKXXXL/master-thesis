...
\\ \goodType{\Gamma, p_1\nu' \ \sigma}{p_2\nu \ (\nu^+ \ \sigma \ \{f\} \ T) \equiv T}{}
}\YZ{p_f nu' or p_f nu? In the syntax figure, you only have p_f nu, I think.}\EDJreply{p_f nu, I don't have p_f nu' here. the prime is just for specifying we are taken out the abstraction result.}
$$
