...
require \textit{de bruijn lifting}: for
$\goodTerm{\Gamma}{\sigma}{\Delta}$, we define its de Bruijn lifting
$\goodTerm{\Gamma,A[\sigma]}{\sigma^\uparrow}{\Delta, A}$ given
$\goodType{\Delta}{A}{}$.\YZ{What is A[sigma] and what is de Bruijn lifting? Seems like if the reader is not familiar with the substitution calculus, then they will get lost starting here. Broadly speaking, a gentle intro to the intrinsic setting would help the reader a great deal.}
