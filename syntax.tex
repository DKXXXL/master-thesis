...
very much like a function that transform a given linkage. Like plugin implementation and \ruleref{Lnkg Add}, we resolve \ref{chg:consistency} by making sure corresponding fields are in corresponding context during inheritance, and an overriding term can only refer to fields before it. 
