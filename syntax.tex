...
\Rule[name=Univ-1]
{\goodType{\Gamma}{T}{j}}
{\goodTerm{\Gamma}{"c" \ T}{\cU}\YZ{what is c? Why is this rule called Univ-1?Didn't you write that you omit universe levels?}\EDJreply{I just kind of afraid they will think there is one universe. Let me remove all the indices}
}\quad
\Rule[name=Univ-2]
{\goodTerm{\Gamma}{T}{\cU}}
{\goodType{\Gamma}{El \ T}{j}\YZ{'El T' isn't explained only until it makes a second appearance in Ind-Term.}}
\quad
\Rule
{}
...
\Rule[name=Sig Add]
{\goodSig{\Gamma}{\sigma}{n} 
 \quad \goodSeal{\Gamma}{f}{\sigma}{A}\YZ{How should I understand 'f' and 'A'?}
...
$\cC$ to get the compiled linkage type (an existential type).\YZ{Why is Csigma needed? How is it different from Lsigma?}
...
{\goodType{\Gamma}{"RecSig1"~A~B~R \equiv (\Pi A (\Pi (\Pi B (R[\pi_1\circ\pi_1])) R[\pi_1\circ\pi_1]) )}{}\YZ{What is R[pi1 circ pi1]?}}
\quad 
\Rule[name=Hdlers]
{\goodWSig{\Gamma}{\sigma}{n}
\quad \goodType{\Gamma}{R}{}
...
\textit{recursor}.\YZ{Do dependent eliminators pose technical difficulties, or do you avoid them solely because they require more verbiage?}
...
\YZ{Seems like you omit many things here, which causes hardship for the reader (at least for me!). I think it's better to list all the rules and decide later what to throw to the appendix.}
...
\sigma}{\_}{A[\pi_1]}$,\YZ{Not quite. Previously you used cL I think.}
...
to be inherited to the children once we override the inductive type. In
other words, there is no way to ``transplant'' $t$ into the context $X_2
: \bW \sigma_2$.\YZ{Is sigma_2 the overriding of sigma_1? The reader has to guess.}
...
Sealing\YZ{It occurs to me that you use the word "sealing" to mean different (though tangentially related) things. Previously you used it as in "sealed families".} is used to exploit this fact---with sealing, given $X_1 : \bW
...
\Rule[name=Inh-Ext]
{\goodInh{\Gamma}{h}{\sigma_1}{\sigma_2}
  \quad \goodTerm{\Gamma, \cL \sigma_2'}{t}{T}\YZ{What is sigma2'?}}
