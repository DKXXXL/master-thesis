...
\end{align*}
\caption{Well-formedness of Four New Judgements, and Agda-encoding-Judgements correspondence}
\end{figure}
...
\sigma}{\_}{A[\pi_1]}$. The substitution law should be understood as a
