...
{}
{\goodType{\Gamma}{\cC \nu\cdot \equiv \top}{} 
\\ \goodTerm{\Gamma}{ \cCt \mu\cdot \equiv ()}{\cL \nu\cdot}\YZ{What is C_t? I don't think you talk about it anywhere.}
\\
\goodType{\Gamma}{\cC (\nu^+ \ \sigma \ \{f\} \ T) \equiv 
...
PPS: Sealing means hiding, so what is being hided? Why do you need to hide it? And how does the 'Compile' and 'Seal' rules perform hiding?}
...
Seal Γ A τ = Tm (Γ, 𝓒σ) A[π₁]@\YZ{tau?}\EDJreply{it should be pi. I fixed it now}\YZreply{Why is tau not used in the definition?}@
