...
types are the ones sealing is responsible for hiding.\YZ{Is sealing really hiding these fields (that use Wsup and Wrec), or is it that the concrete definition of an inductive type is not hidden for these fields so that they can assume knowledge about the inductive type's signature?}
After compilation
