...
Note that, there will be a lot of $\sigma_1, A_1$ and $\sigma_2, A_2$, in these cases, $A_1$ is the result of the sealing of $\sigma_1$, i.e. we assume we have a term $\goodSeal{\Gamma}{f_1}{\sigma_1}{A_1}, \goodSeal{\Gamma}{f_2}{\sigma_2}{A_2}$ in the assumption when needed.
