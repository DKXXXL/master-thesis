...
\goodTerm{
    ...
    \fontsize{8.0}{9.2}\selectfont%
    \begin{gather*}
    \tikzmarkin[disable rounded corners=true,set fill color=T-color,set border color=T-color]{T10-b}(-0.02,-0.45)(-0.02,0.60)
    \begin{array}{@{}l@{}}
        \El{\getfield{\mathit{self}}{\texttt{tm}}} \to
        \\
        \El{\getfield{\mathit{self}}{\texttt{tm}}} \to
...
\begin{tabular}{ll}
  ...
  $\TyTkg{\lsig_6} = \nTySigma{P_5}{\TyTkg{\lsig_5}}{\CaseSig{\top}{\bot}{\El{\getfield{P_5}{"tm"}} \to \mathit{id} \to \El{\getfield{P_5}{"tm"}}}}$\EDJ{It strike me that, we don't have field projection for dependent tuple... so it is a bit ambiguous. I am not sure if I should continue; but some explanation of this field projection is required I believe} & \\ 
