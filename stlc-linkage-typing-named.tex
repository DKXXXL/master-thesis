...
$\quad \{\wsig_{\texttt{tm}}^0 \coloneq \WSigAdd{\WSigEmp}{\bbone}{\lambda \_ . \bbzero},
 \ \  \wsig_{\texttt{tm}}^1 \coloneq \WSigAdd{\wsig_{\texttt{tm}}^0}{\bbone}{\lambda \_ .\bbtwo}\ \ ...,  \wsig_{\texttt{tm}}\}$
}
\\
\\[-8pt]
\cellcolor{Bkg-color}
...
&
\goodTerm{\TyTkg{\lsig_9}}{\seal_{10}}{{
