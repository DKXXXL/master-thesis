...
\lstdefinelanguage{Coq}{
  ...
  morekeywords=[1]{Section, Module, End, Require, Import, Export,
      ...
      FRecursion, FInduction, Case, MetaData, EndMetaData, Closing, Final, Inherit,
      },
  % Gallina
  ...
  % Gallina: Family Poly
  morekeywords=[3]{on, motive,},
  % Sorts
  morekeywords=[4]{Type, Prop, Set, true, false, option},
  ...
  basicstyle=\fontsize{8.0}{8.5}\ttfamily,
  ...
  stringstyle=\ttfamily,
  % Style for comments
  commentstyle={\ttfamily\itshape\color{codecomment-color}},
...
\newcommand\codecomment[1]{%
  {\color{codecomment-color}\ttfamily(*\;#1\;*)}%
}
