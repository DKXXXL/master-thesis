...
The handling of linkages in both models are inspired by the handling of sigma types, as we syntactic translated linkages to sigma types in the earlier section.