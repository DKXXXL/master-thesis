...
closed, ``reducible'' terms of type~$T$.\EDJ{I will add a it is my bad to introduce "reducible" without defining it first. But my intension is to give a feeling of the dynamic operational semantic for the reader (of course OS is not here in our setting)}\YZreply{Is there a more accurate way to say things here?}
