...
Linkages~$\LkgAdd{\lkg}{t}$ can be interpreted into non-dependent products\EDJ{Suggesting changing to ``can be interpreted into non-dependent pair with dependent function for late-binding''},
