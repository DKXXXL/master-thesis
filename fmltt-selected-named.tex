...
\text{Linkage signatures} & \lsig & \Coloneqq &
    \LSigEmp \mid \LSigAdd{\lsig}{x.\seal}{a.T} \mid \lsigproj{1}{\lsig} \mid \RecSig{\wsig}{T} 
\tikzmarkend{New5}
    \\
...
\Rule[name=tm/wsup]{
    ...
    \\\\
    \goodTerm{\Gm, a : {\wsigproj{i}{2}{\wsig}[t_1/x]}}{t_2}{\El{\wcode{\wsig}}}
%   \\
%   i \in \{1, ..., n\}
}{
    \goodTerm{\Gm}{\Wsup{i}{\wsig}{t_1}{a.t_2}}{\El{\wcode{\wsig}}}
}
...
\Rule[name=lsig/add]{
    ...
    \goodSig{\Gm}{\LSigAdd{\lsig}{x.\seal}{a.T}}{n+1}
}
\hfill
\Rule[name=l/empty]{
}{
...
\Rule[name=l/add]{
    ...
    \goodTerm{\Gm}{\LkgAdd{\lkg}{a.t}}{\TyLkg{\LSigAdd{\lsig}{x.\seal}{a.T}}}
}
\hfill
\Rule[name=tm/inh]{
...
\Rule[name=tmeq/ov/beta]{
    ...
    \goodTerm{\Gm}{\lkg}{\TyLkg{\lsig_1}}
    \\\\
    \goodTerm{\Gm, a_1 : A_1}{t_1}{T_1}
    \\
    \goodTerm{\Gm, x_1 : \TyTkg{\lsig_1}}{\seal_1}{{A_1}}
    \\
    \goodTerm{\Gm, a_2 : A_2}{t_2}{T_2}
    \\
    \goodTerm{\Gm, x_2 : \TyTkg{\lsig_2}}{\seal_2}{{A_2}}
}{
    \goodTerm{\Gm}{
        \inh{\InhOv{h}{a_2 . t_2}}{\LkgAdd{\lkg}{a_1 . t_1}}
        \equiv 
        \LkgAdd{\inh{h}{\lkg}}{a_2 . t_2}
    }{
        \TyLkg{\LSigAdd{\lsig_2}{x_2.\seal_2}{a_2.T_2}}
    }
}
