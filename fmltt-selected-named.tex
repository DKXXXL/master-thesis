...
\Rule[name=tm/wsup]{
    ...
    \\\\
    \goodTerm{\Gm, x : \nsub{\wsigproj{i}{2}{\wsig}}{x}{t_1}}{t_2}{\El{\wcode{\wsig}}}\YZ{Is 'a' a typo?}\EDJreply{Yes. Fixed.}\YZreply{Two x's serving different purposes is a little confusing. The real cause you have to have two x's is that the projection does not return the free variable's name. Write this rule by induction on n (rater than projection)?}
%   \\
%   i \in \{1, ..., n\}
}{
