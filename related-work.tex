...
\noindentparagraph{Proof reuse, proof weaving, and proof repair.}
...
extensions (including distinct names for constructors), while our
approach supports the late binding of names.
