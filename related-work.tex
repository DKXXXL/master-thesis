...
motivated later approaches based on \emph{data types à la carte} (DTC)~\cite{dtc}. \rB{ define abbreviation DTC at first use?}\EDJreply{changed, please review.}
DTC has in turn served as a source of inspiration for numerous work
