...
meta-operations. We specifically use based path induction
as eliminator for identity type~\cite{program2013homotopy}.
We work in an intrinsically typed setting: terms are well typed by construction, 
%
and consequently some premises are omitted without ambiguity and can be inferred from the context. \EDJ{I added this sentence back here. Why removed this sentence earlier?}\YZreply{I don't find a strong causal connection between the two parts of the sentence}
% 
...
\EDJ{Why removing the mentioning of ``omitted/inferrable k here?'' I know it is confusing but I think it is important to make things rigorous.}\YZreply{I agree it's important, and I'm happy to include it if you make it less confusing.}
