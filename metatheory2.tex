...
Compared to MLTT, \TT has 3 more judgements about signatures and linkage transformers. Moreover, the linkage transformer can be considered as a syntactic sugar (or library functions) and we will show how it can be translated away at the very end. 
...
\subsection{Syntactic Translation to get rid of Linkage Transformer}
