...
%
and consequently some premises are omitted without ambiguity and can be inferred from the context. \EDJ{I added this sentence back here. Why removed this sentence earlier?}\YZreply{I don't find a strong causal connection between the two parts of the sentence}\EDJreply{If it is not intrinsically typed (everything is raw), then no inference can be done.}
% 
...
\EDJ{Why removing the mentioning of ``omitted/inferrable k here?'' I know it is confusing but I think it is important to make things rigorous.}\YZreply{I agree it's important, and I'm happy to include it if you make it less confusing.}\EDJreply{Do you think ``omitting premises'' should be mentioned here or earlier?}
