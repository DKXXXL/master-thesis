...
\item We present, to our knowledge, the first\EDJ{Are you sure? This claim is so bold.}\YZreply{Is there any previous language designs in this space?}\EDJreply{Olivier Boite. 2004. Proof reuse with extended inductive types. In International Conference on Theorem Proving in
Higher Order Logics. Springer, 50–65.  I think I also mentioned several paper in the related work.} language design that enables extensible
