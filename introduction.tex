...
\item We present the first\EDJ{Are you sure? This claim is so bold.} language design that enables extensible
...
We derive strong meta\-theoretical\EDJ{I will suggest use ``foundational'' instead. Sterling at some places say canonicity is the most basic meta-theoretical property.} results including consistency and
canonicity.
