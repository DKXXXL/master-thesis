...
\begin{align*}
  \denotesC{\goodCtx{\Gm}{k}} & \text{ is a Set of closed substitution} \goodSub{\cdot}{\_}{\Gm} \\
  % &\text{and we define } \goodCtxS{\Gm}{i} :\iff \denotesC{\goodCtx{\Gm}{i}} \text{ is defined} \\
  \denotesC{\goodType{\Gm}{T}{j}} & \text{ is a function maps to $\Set{j}$ s.t.} \\
  & \text{for arbitrary } \gm \in \denotesC{\goodCtx{\Gm}{}}, \denotesC{\goodType{\Gm}{T}{}}(\gm) \text{ is a an element of } \Set{j}  \\ 
