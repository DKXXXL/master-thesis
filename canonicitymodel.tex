...
\begin{align*}
  ...
  \begin{cases}
    \{\star\} & \text{if } \sub{t}{\gm} \equiv \eqrefl{\sub{a}{\gm}} \text{ and } \sub{a}{\gm} \equiv \sub{b}{\gm}\\
    \emptyset & \text{otherwise }
  \end{cases}\\
  \denotesC{\goodTerm{\Gm}{\Jeq{w}{t}}{\sub{C}{\SubstExt{\SubstExt{id}{v}}{t} }}}(\gm)(\gm') &= \denotesC{w}(\gm)(\gm') \quad \quad \text{ for } \goodTerm{\Gm}{t}{\TyId{u}{v}} \\ 
