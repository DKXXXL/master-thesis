...
\begin{align*}
  ...
  \denotesC{\goodTerm{\Gm}{\lkgproj{1}{\ell}}{\TyTkg{\lsig}}} &= \Gfst{\denotes{\ell}} \\
  \denotesC{\goodTerm{\Gm, \lsigprojT{\lsig}}{\lkgproj{2}{\ell}}{T}} &= \Gapp{\Gsnd{\denotes{\ell}}} \\
  ...
  \denotesC{\goodType{\Gm}{\CaseSig{A}{B}{R}}{}} &= {\GluedPi{A}{\GluedPi {\GluedPi{B}{\Gsub{R}{\GSubstWeak{2}}}} {\Gsub{R}{\GSubstWeak{2}}}}}\\
