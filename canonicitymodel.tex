...
\begin{enumerate}
  ...
  \item Then we apply it with two substitution,  $\GSubstExt{{\GSubstWeak{1}}}{s}$ and $\GSubstExt{\Glued{("id")}}{ \Glued{\ell'} }$
  \item Then we use glued interpretation of dependent tuple to combine it with $\Gpair{\Glued{\ell'}}{...}$
\end{enumerate}
