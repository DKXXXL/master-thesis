...
EndFamily.
\end{minted}
  \end{minipage}\YZ{Can the self's be omitted?}\EDJreply{Yes. But in our current plugin implementation it is not omitted. I think altering example is fine. If you think some small distance between example and the current implementation is fine, please comment back and I will remove all the self_}
...
three components.\YZ{Typo? Are they a_4, a_5, a_6 in Figure 2?}\EDJreply{Thanks, fixed.}
...
module.\YZ{'For example, ...'}\EDJreply{I don't think explaining a Coq feature inside our paper is a good idea? But I have added this in the following line, please check and retain it if you find this ok. }
...
exposing the whole definition directly into module type. Doing so we also prohibit overriding because
