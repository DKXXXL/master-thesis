...
to override "a" and inheriting "c" in the future, but they are conflicting, since "c" witnesses "a" fix to "1". On the other hand, once we decorate it upon "a'", the second attempt \mintinline{Coq}{c : a' = 1 := eq_refl} will succeed. Contrary to "a", our "a'" is not overridable in "Family I2", mediating the \ref{chg:definition-relevant-reasoning}.
