...
For example, the four case handlers (\lsti{subst\_tm_var} etc.) compiled for \lsti{STLC}
are reused to instantiate \lsti{subst}.
Translations of the definition of \lsti{env} and the proof of \lsti{typesafe},
