...
this special treatment.\YZ{This para is confusing: which kind of equality is used, propositional or judgmental? Where does 'Final' show up in the example?}\EDJreply{I rephrase it and remove the part on talking about meta-theory. Now everything is about judgemental so I don't have to emphasize judgemental. I wanted to make the example small but I guess I can add one `Final' statement into our example. Don't resolve it until I add it into Figure 2.}
...
abstracted interface'' the compiled module type "b_3". We cannot export\YZ{export or put?}
...
checking\YZ{Why is it 'extra'? Is there already exhaustiveness checking anywhere?}). This is affordable since each recursor handler doesn't need
