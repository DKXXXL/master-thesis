...
three components. {The "EmptySig" is just empty module type.} Then,
...
checking and overriding as in \ref{langdesign-req0}---for example, we
want to override "Field a", we simply replace that compiled module with
the new module inside the list. This compiled module type serve as an
abstraction to let overriding possible.
