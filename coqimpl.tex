...
%
As discussed in \cref{sec:latebind}, \lsti{subst} can be further bound,\EDJ{If we don't allow further bound of case handler(mentioned in your last reply), how do the user further bound the subst? I mean in the surface syntax}
