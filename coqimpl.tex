...
modular compilation requirement. Compared with alternatives that create
wrapper inductive types, we consider it a small price to pay in return
for the clarity of implementation especially given that compiled case handlers
