...
implementation of "f", we just override the whole ``sealed'' family, like we do in "I2.MonotonicF". And the compiled module type of "I2.MonotonicF" will be fixed throughout the extension---it is always these two fields "f, p".
