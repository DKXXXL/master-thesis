...
\noindentparagraph{Trusted Code Base.} Finally we emphasize that our compilation can make sure the trusted code base is restricted to the Coq's kernel, as all the feature supported by our plugin has been compiled into Coq's surface syntax/Vernacular commands.
