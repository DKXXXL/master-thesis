...
checking and overriding as in \ref{chg:software-engineering}---for example, if we
...
thus maintains all the computational mechanism from Coq, resolving \ref{chg:software-engineering}. 
...
\ref{chg:definition-relevant-reasoning}. However, the current implementation is not satisfactory enough. There are cases where we need to expose
