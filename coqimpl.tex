...
\textbf{Reasoning Requires Non-Overridable.}\YZ{At this point in this section, overriding has not been discussed yet, but it is already discussing non-overridables. Should probably discuss the extensibility first.}
...
implementation of "f", we just override the whole ``sealed'' family, like we do in "I2.MonotonicF".
