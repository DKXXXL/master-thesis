...
\subsection{Language Design}\YZ{I think in §3.1, you should use a figure to show how the actual code the programmer will write to solve the programming challenge outlined in Figure 1.}
