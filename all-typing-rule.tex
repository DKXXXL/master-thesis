...
For the singleton type $\TyS{a}$, we formulate in a more readable way instead of using the explicit introduction and elimination rule (e.g. a more explicit introduction rule will have a `constructor' $\frac{\goodTerm{\Gm}{a}{A}}{\goodTerm{\Gm}{"s"~a}{\TyS{a}}}$).
