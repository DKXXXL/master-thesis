...
{\goodTerm{\Gm}{\lkg}{\TyLkg \lsig}}
{\goodTerm{\Gm}{\LkgAdd{\lkgproj{1}{\lkg}}{\lkgproj{2}{\lkg}}{\TyLkg{\lsig}} \equiv \lkg }{\TyLkg{\lsig}}}
\\
...
\\ \goodTerm{\Gm}{\Tkg {(\LkgAdd {\lkg} {t})} \equiv ((\Tkg {\lkg}), t["sf" \ f][(id, \Tkg {\lkg})]) }{}
}
...
{\goodTerm{\Gm}{\inh {\goodInh{\Gm}{\InhExt {h} {t}}{\sigma_1}{(\LSigAdd {\sigma_2} {\seal_2} { T})}} {\lkg}
