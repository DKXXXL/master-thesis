...
\quad  \goodSeal{\Gm}{f}{\lsig}{A} 
 \quad \goodTerm{\Gm, A}{t}{T}}
{\goodTerm{\Gm}{p_1\mu \ (\LkgAdd {o} {t}) \equiv o}{\cL \lsig}
\\ \goodTerm{\Gm, A}{p_2\mu \  (\LkgAdd {o}{t}) \equiv t}{T}
}
$$
$$
\Rule[name=Compile]
...
\\\\ \goodTerm{\Gm}{ \cCt \LkgEmp \equiv ()}{\TyTkg{\nu\cdot}}
\\ \goodTerm{\Gm}{\cCt \ (\LkgAdd {o} {t}) \equiv ((\cCt \ o), t["sf" \ f][(id, \cCt \ o)]) }{}
}
$$
