...
\noindent%
\headerfont{Types} \quad
$ \tau \ \Coloneqq\ \mathbb{1} \bnf  \tau_1 \to \tau_2 $
\medskip

\headerfont{Terms} \quad
...
\noindent%
\headerfont{Types} \quad $ \tau \ \Coloneqq\ \cdots $ \textit{(no change)}
\medskip

\headerfont{Terms} \quad $ e \ \Coloneqq\ \cdots \bnf \mathrm{fix}\,x.\,e $
\medskip

\headerfont{Typing rule}
\begin{mathpar}
\cdots
