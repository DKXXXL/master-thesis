...
We first define a new type $\goodType{\Gamma}{\Sigr{\Gamma}{n}{j}}{}$  when
$\goodCtx{\Gamma}{}$  is well-formed and $n \in \mathbb{N}$
such that $\goodTerm{\Gm}{\denotesT{\goodSigU{j}{\Gamma}{\lsig}{n}}}{\Sigr{\Gm}{n}{j}}$.
We make $({\Sigr{\Gamma}{n}{}})$ and $\denotesT{\TyTkg {-}}$ mutually recursive,
...
\begin{align*}
  {\Sigr{\Gamma}{(n+1)}{j}} &= 
    \Sigma~(\Sigr{\Gamma}{n}{j})
          ~(\Sigma~\cU_j \\
          & \quad \quad ~(\Sigma~(\TyPi{\denotesT{\TyTkg {\sub{\var{0}}{\SubstWeak{1}}}}}{\El{\sub{\var{0}}{\SubstWeak{1}}}}) \\
...
However, when we mutually recursively define
