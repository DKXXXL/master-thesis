...
computational property of Coq when using families}. Coq, as a constructive
logic, has been famous for its ability to do calculations and extract
programs. We don't want our Family facility to ruin this: the developers
should be able to project field as first-class value just like Coq's
Module.
