...
\hline
\rowcolor[HTML]{FFFFE6} 
surface-syntax program & $i$ & $\sigma_i = \LSigAdd{\sigma_{i-1}}{s_i}{T_i}$ & $\sigma_i' = \LSigAdd{\sigma_{i-1}'}{s_i'}{T_i'}$ \\ \hline
\lsti!Family STLC_bool...! & 0        & $\{\}$                                   & $\{\}$                                   \\ \cline{2-4} 
...
\hline
\rowcolor[HTML]{FFFFE6} 
surface-syntax program     & $i$      & $\goodInh{..}{h_i}{\sigma_i}{\sigma_i'}$             \\ \hline
