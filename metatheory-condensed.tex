...
In dependent type system, types are treated as terms, and should have a type. \rA{Why is W(t) a term and not a type?}\EDJreply{changed, please review.}
We use Tarski-style universes~\cite{hofmann1997syntax}: every type has a \emph{code}, inhabits in a universe~$\cU$,
