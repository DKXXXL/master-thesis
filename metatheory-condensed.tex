...
\begin{figure}
  \begin{tabular}{|
    >{\columncolor[HTML]{FFFFFF}}l |l|l|l|}
    \hline
    $\wsig_{\texttt{tm}}^{\texttt{unit}} \coloneq \WSigAdd{\WSigEmp}{\bbone}{\lambda \_ . \bbzero}$ 
    & $\wsig_{\texttt{tm}}^{\texttt{var}} \coloneq \WSigAdd{\wsig_{\texttt{tm}}^{\texttt{unit}}}{"id"}{\lambda \_ . \bbzero}$
    & $\wsig_{\texttt{tm}}^{\texttt{abs}} \coloneq \WSigAdd{\wsig_{\texttt{tm}}^{\texttt{var}}}{"id"}{\lambda \_ .\bbone} $ 
    & $\wsig_{\texttt{tm}}^{\texttt{app}} \coloneq \WSigAdd{\wsig_{\texttt{tm}}^{\texttt{abs}}}{\bbone}{\lambda \_ .\bbtwo}$  \\ \hline
    \end{tabular}
\end{figure}
