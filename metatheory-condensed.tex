...
In dependent type system, types are treated as terms, and should have a type. % Reviewer A : Why is W(t) a term and not a type?
...
we can constructs a term $\Wsup{\wsig}{t_1}{t_2}$ of type~$T$ (rule \ruleref{tm/wsup}). % Reviewer B: Line 666
