...
that hides W-type signatures, if necessary.
When no hiding is needed, $\seal$ is the identity $\var{0}$ and $A$ is
$\TyTkg{\lsig}$.

\bigskip


A supplemental appendix gives a more complete example showing how families
are modeled and type-checked as linkages.
