...
Our formulation of W-types differs from previous ones in that it makes
individual constructors explicit and thus more closely matches the surface
syntax of \Lang.
%
In \TT, a W-type is given by a \emph{W-type signature} $\goodWSig{\Gm}{\wsig}{n}$ 
