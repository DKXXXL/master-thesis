...
a universe~$\cU$ is not inhabited by types directly\footnote{On the contrary, 
Russel-style Universe is inhabited by types directly. 
Tarski-style universe is ``semantically more fundamental''\cite{luo2012notes} and more friendly for our meta-theoretical reasoning.},
...
\rA{Why is W(t) a term and not a type?}\EDJreply{changed, please review.}\YZreply{I think the reviewer is wondering what is gained by encoding and decoding types, compared to types directly inhabiting universes.}\EDJ{changed again, please review.}
