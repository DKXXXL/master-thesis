...
For each pair of types identifying a constructor, the first type may be thought of
as the non-inductive part of the constructor, and the second type as the arity
...
\noindent
Thus, the encoding of \lsti{tm_abs} has type
