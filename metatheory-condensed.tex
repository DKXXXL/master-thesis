...
for simplicity, we model non-dependent motives for recursion.\YZ{Does "for recursion" here convey relevant information?}\EDJreply{no. I actually wanted to say "non-dependent motives for non-dependent recursion". Maybe change to "only model non-dependent motives"??}
