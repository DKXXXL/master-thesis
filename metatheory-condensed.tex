...
a universe~$\cU$ is not inhabited by types directly\footnote{By contrast, 
Russel-style universes are inhabited by types directly. 
Tarski-style universes are ``semantically more fundamental'' \cite{luo2012notes} and friendlier to our meta-theoretical reasoning.},
