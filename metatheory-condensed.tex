...
we can constructs a term $\Wsup{\wsig}{t_1}{t_2}$ of type~$T$ (rule \ruleref{tm/wsup}). \rB{for readability please add text between "T," and "Wsup"}\EDJreply{changed, please review}
...
% Add example for representing tm here
