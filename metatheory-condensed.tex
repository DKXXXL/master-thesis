...
\item
\TT also features \emph{linkage transformers} that enable inductive
construction of linkages (and thus families): a linkage can be constructed by inheriting or
...
For simplicity, we model non-dependent motives.
This collection of case handlers~$\lkg$ then encodes those defined and inherited
...
projecting it and then including it.
