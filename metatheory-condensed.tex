...
\begin{figure}[!htb]
  ...
  (* ↑s₃ map (the type of) s₃₁' to the sealing before extension  s₃₁ *)
  ii₃₀₀ = inh-id 
        : Inh (⋅, [ty : 𝕌; ..; tm_true : tm; ..])
              (RecSig τ₂  tm)[p₀, ↑s₃]
              (RecSig τ₂  tm)[p₀, ↑s₃]
  ...
  (* s₃' : {ty : W(τ₁'); tm : W(τ₂'); subst' : 𝕃(RecSig τ₂' tm) }
          | [ty : 𝕌; .. ; tm : W(τ₂'); subst' : 𝕃(RecSig τ₂' tm)] *)
  i₃ = inh-ov i₃₁ ..
     : Inh ⋅ {ty : W(τ₁); tm : W(τ₂); subst' : 𝕃(RecSig τ₂ tm); subst : tm → nat → tm → tm}  
             {ty : W(τ₁'); tm : W(τ₂'); subst' : 𝕃(RecSig τ₂' tm); subst : subst : tm → nat → tm → tm}
  (* recall s₄ : {ty : W(τ₁); .. subst : .. } 
  ...
  ↑s₄ : Tm (⋅, [ty : 𝕌; .. ; tm : 𝕌; .. ; subst' : 𝕃(RecSig τ₂ tm);subst : ..]) 
          [ty : 𝕌; .. ; tm : 𝕌; .. ;subst' : 𝕃(RecSig τ₂ tm); subst : ..]
  i₄ = inh-inh i₃ ↑s₄ :
    Inh ⋅ {ty : W(τ₁); .. subst : ..; t1 : 𝕊(tm_var 0)} 
          {ty : W(τ₁'); .. subst : ..; t1 : 𝕊(tm_var 0)} 
  \end{lstlisting}
