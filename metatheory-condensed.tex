...
%
In the literature,
a W-type is given by a pair of types $\goodType{\Gm}{A}{}$ and $\goodType{\Gm,A}{B}{}$,
but our formulation of W-types additionally
allows a W-type signature \goodWSig{\Gm}{\wsig}{n} to
specify $n$ pairs of types (\ruleref{wsig/empty} and \ruleref{wsig/add}).
Each pair models a constructor in an inductive type,
with $\goodType{\Gm}{\wsigproj{i}{1}{\wsig}}{}$
and $\goodType{\Gm,\wsigproj{i}{1}{\wsig}}{\wsigproj{i}{2}{\wsig}}{}$
identifying the $i$-th constructor, and $\wcode{\wsig}$ giving the code of the
W-type (\ruleref{tm/w}).
%
Rule~\ruleref{tm/wsup} states that 
given two arguments $\goodTerm{\Gm}{t_1}{\wsigproj{i}{1}{\wsig}}$ and
$\goodTerm{\Gm,\sub{\wsigproj{i}{2}{\wsig}}{\SubstExt{\SubstWeak{0}}{t_1}}}{t_2}{\El{\wcode{\wsig}}}$,
we can construct a term $\Wsup{\wsig}{t_1}{t_2}$ of the W-type.
