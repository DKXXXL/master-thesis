...
For each derivation (of each judgment)\YZ{I don't get what 'each derivation' or 'each judgment' means}
we introduce judgmental equality (of the form \goodTerm{\Gm}{t_1 \equiv t_2}{T})
...
$\goodType{\Gm,\wsigproj{i}{1}{\wsig}}{\wsigproj{i}{2}{\wsig}}{}$\YZ{this is still in de Brujin}
models the $i$-th constructor---given
...
W-type (\ruleref{tm/w}).\YZ{What's the rationale behind naming the free variable 'self'?}
