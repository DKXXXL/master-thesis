...
$\goodType{\Gm,x : \wsigproj{i}{1}{\wsig}}{\wsigproj{i}{2}{\wsig}}{}$\YZ{this is still in de Brujin}\EDJreply{Changed}
...
we can construct a term $\Wsup{i}{\wsig}{t_1}{x.t_2}$ of the W-type. $\wcode{\wsig}$ gives the code of the
W-type (\ruleref{tm/w}).\YZ{What's the rationale behind naming the free variable 'self'?}\EDJreply{Self is not making sense, changed sorry.}
