...
\goodTerm{\Gm}{t_1 \equiv t_2}{T},\goodType{\Gm}{T_1 \equiv T_2}{},\goodCtx{\Gm_1 \equiv \Gm_2}{} ..., etc. Following \citet{altkap2016}, we consider our syntax to be quotiented by these equalities, and thus each syntax piece is actually one (equivalent) class of syntax. Doing such quotient gives us convertibility for free---when we have definitionally equal $A \equiv B$, thanks to the quotient, the derivation of $t : A$ is the same as the derivation of $t : B$.\YZ{Since you are talking about quotienting, should you mention that the underlying logical framework is QIIT?}
...
Following \citet{kaposi2019gluing}, we use \emph{Universe à la Coquand} \cite{coquand2013presheaf}. Unlike Russell-style ones, Coquand universes are not inhabited by types directly but rather by the \emph{codes} of types
