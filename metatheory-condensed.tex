...
\definecolor{P-color}{HTML}{BFEFFF}
...
dependent tuple type rather than a linkage type; we expand on this issue in an
appendix.}
%
...
while $\seal_6$ hides $"tm" : \TyS{\wcode{\wsig_{\texttt{tm}}}}$
as $"tm" : \cU$ in $A_6$
so that the typing of~$t_6$ is oblivious to the concrete signature
