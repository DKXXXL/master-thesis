...
the typing of~$t$ in \ruleref{l/add} is \emph{universally} quantified over
...
\ruleref{lsig/add} do not necessarily contain the same types of the prior fields as recorded by~$\TyLkg{\lsig}$,
