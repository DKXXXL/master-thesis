...
signature of our "tm" and showcase the meta-theoretic encoding of "unit" and "app~unit~unit". $"elim-"\bbzero$ indicates the elimination of the bottom type $\bbzero$ in the context. The expressiveness of W-types comes from the ``arity'', as it encodes the case when recursive structure stores as the output of a function, mirroring the strict-positivity of Inductive type.
