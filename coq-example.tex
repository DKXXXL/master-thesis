...
can\YZ{In general, in a result section like this, you want to show what
you *have done* rather than what you *can do*.}
swap the implementation of "State" to have different memory/state
management by extending family "Lang".\YZ{What is 'different
...
computability in the presence of family.\YZ{Can there be a diagram (a la Figure 1 in Familia paper) illustrating the relationships between (and functionalities of) the different families?}