...
our example uses small-step operational semantics\YZ{Does MTC not define a small-step operational semantics for STLC?} by exploiting
extensible inductive types, and most of the proof is directly adapted
from the one in Software Foundation, resulting in a more accessible proof.\YZ{Can you say more about how your plugin enables more code reuse and modularity?}
...
on Coq to auto-generate them;\YZ{I was under the impression that the plugin could not auto-generate Closing Facts or their proofs, no?} (2) it shouldn't bother us in the future
...
We construct four families, in one inheritance chain.\YZ{Why is it useful to define these concrete and abstract interpreters as an inheritance chain?}
