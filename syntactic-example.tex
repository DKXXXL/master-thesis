...
"pred" will map $S~n \mapsto (n, S~n)$ and $O \mapsto (O, O)$\YZ{looks like an ill-founded definition}\EDJreply{Fixed}, and thus a predecessor.
...
Family A.
 ...
 FRecursor pred about self[A].N 
  ...
  using handler.@\YZ{Why is there no FRecursor?}\EDJreply{I wanted to save space and emphasize the type. Now fixed}@
 (* pred
