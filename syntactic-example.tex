...
First Note that how inductive type is written in our format. We use 1, 0 here to indicate unit type and bottom type:
\begin{minted}{Coq}
Inductive N :=
 | O : 1 -> (0 -> N) -> N 
 | S : 1 -> (1 -> N) -> N
...
\end{align*}
  ...
  \begin{minipage}{\linewidth}
    \begin{align*}
      ...
      "inh"_5 &:= \goodInh{\cdot}{\_}{"sig"_4}{"sig"_{41}} \\ 
      "sl"_{41} &:= \goodSeal{\cdot}{\_}{"sig"_{41}}{"sig"_{41}'} \\ 
      \uparrow^s_2 &:= \goodTerm{\cdot, "sig"_{41}}{\_}{"sig"_4'[\pi_1]} \\ 
      "inh"_6 &:= \goodInh{\cdot}{\_}{"inh"_5}{\uparrow^s_2}
    \end{align*}  
  \end{minipage}
  \caption{Detailed Construction}
\end{figure}
